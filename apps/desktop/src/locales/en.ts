...
export const en = {
  ...
  browserHint: "No store button yet? Load it manually — Firefox: about:debugging → This Firefox → Load Temporary Add-on. Chromium: chrome://extensions → Developer mode → Load unpacked. Or install the signed .xpi from the latest release for a permanent Firefox add-on.",
  ...
  obLinks: "Grab links",
  obBrowser: "Set up browser capture",
  theme: "Theme",
